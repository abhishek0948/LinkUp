...
import link_up_chat_background from "../../assets/images/LinkUp_chat_background.png";
import {
  FaArrowLeft,
  FaEllipsisH,
  FaFile,
...
import VideoCallManager from "../video_call_section/VideoCallManager";
...
const ChatWindow = ({ selectedContact, setSelectedContact, isMobile }) => {
  ...
  const groupedMessages = Array.isArray(messages)
    ? messages.reduce((acc, message) => {
        ...
        if (isValidate(date)) {
          ...
          console.error("invalid date for message");
        }
        return acc;
      }, {})
    : {};
  ...
  // console.log("Printing selected contact", selectedContact);
    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center mx-auto h-screen text-center">
        <div className="max-w-md">
          ...
          >
            <span>Select conversation to start chatting</span>
          </h2>
          <p
            className={`${
          ...
          >
            <span>Choose a contact from list on left to begin messaging</span>
          </p>
          <p
            className={`${
              theme === "dark" ? "text-gray-400" : "text-gray-600"
      ...
      <div className="flex-1 h-screen w-full flex flex-col">
        ...
        >
          ...
          <img
            ...
            alt={selectedContact?.username[0]}
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <FaVideo className="h-5 w-5 text-blue-400 hover:text-blue-500 " />
            </button>
